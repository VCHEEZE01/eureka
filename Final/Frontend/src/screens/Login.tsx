 ...
 * 프론트엔드에서는 인증 없이 이메일만 받아 로그인 상태를 흉내 낸다.
 */
      ...
      <Page>
        <div className="max-w-[440px] flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            ...
            <Body>
              저장한 문제를 계정에 묶어둡니다. 문제 탐색은 로그인 없이도 볼 수 있습니다.
            </Body>
          </div>
          ...
          <div className="rounded-[12px] bg-bg-subtle border border-border p-4">
            <Caption>
              프론트엔드 프로토타입이라 실제 인증은 하지 않습니다. 입력한 값은 이 브라우저에만
              저장되고 서버로 전송되지 않습니다. 실제 로그인 방식(이메일·소셜 등)은 아직
              정해지지 않았습니다.
            </Caption>
          </div>
        </div>
